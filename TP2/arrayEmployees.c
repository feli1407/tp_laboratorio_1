    ...
    if(list!=NULL &&len>0 && punteroId!=NULL)
    {
        if(buscarLibre(list,len)!=-1)
        {
            do
            {
                ...
                fflush(stdin);
                if(!(getNumeroFlotante(&nuevoempleado.salary,"Ingrese sueldo:","Error ",0,150000,3)))
                {
                    printf(" ocurrio un error en la validacion\n");
                    errorValidacion=1;
                    system("pause");
                ...
                fflush(stdin);
                if(!(getNumero(&nuevoempleado.sector,"Ingrese sector (0-1000):","Error ",0,1000,3)))
                {
                    printf(" ocurrio un error en la validacion\n");
                    errorValidacion=1;
                    system("pause");
...
int bajaEmpleado(Employee* list, int len)
{
    ...
    while(findEmployeeById(list,len,idDeLaBaja)==-1&&list[findEmployeeById(list,len,idDeLaBaja)].isEmpty!=1);
